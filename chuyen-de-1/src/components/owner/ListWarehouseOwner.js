    ...
    <>
      ...
      <div class="container mt-5 mb-5">
        <div class="d-flex justify-content-center row">
          <div class="col-md-10">
            <Link to="/create" className="btn btn-success my-3" style={{marginLeft:800}}>
              Create +
            </Link>
                  ...
                  <div class="row p-2 bg-white border rounded mb-2">
                    <div class="col-md-3 mt-1">
                      <img
                        ...
                        src={itemWarehouse.imageWarehouse}
                    ...
                    <div class="col-md-6 mt-1">
                      ...
                      <div class="mt-1 mb-1 spec-1">
                        ...
                        <span class="dot"></span>
                        <span>{itemWarehouse.monney}</span>
                        <span class="dot"></span>
                        <span>
                          {" "}
                          VNĐ
                      ...
                      <div class="mt-1 mb-1 spec-1">
                        ...
                        <span class="dot"></span>
                        <span>
                          {itemWarehouse.currentCapacity} /
                          {itemWarehouse.capacity}{" "}
                          {itemWarehouse.category.acreage}
                          <br />
                        </span>
                      </div>
                      ...
                      <span class="text-justify text-truncate para mb-0">
                        {itemWarehouse.description}
                        <br />
                        <br />
                      </span>
                    </div>
                    <div class="align-items-center align-content-center col-md-3 border-left mt-1">
                      <div class="d-flex flex-column mt-4">
                        <button
                          ...
                          type="button"
                          onClick={() => {
                            navigate("/UpdateWarehouseOwner", {
                              state: { id: itemWarehouse._id },
                            });
                          }}
                        >
                          Thay đổi thông tin
